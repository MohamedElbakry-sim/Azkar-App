...
import { Search, Book, Bookmark as BookmarkIcon, Layers, Grid, ChevronLeft, PlayCircle } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto pb-20 space-y-6">
      ...
      {bookmark && (
        <div 
            ...
            className="mx-4 md:mx-0 bg-gradient-to-r from-emerald-600 to-teal-700 rounded-3xl p-5 text-white shadow-lg shadow-emerald-500/20 cursor-pointer relative overflow-hidden group"
        >
             ...
             <div className="relative z-10 flex items-center justify-between">
                 <div>
                     ...
                     <p className="text-emerald-100 text-sm">
                         توقفت عند الآية <span className="font-mono font-bold">{bookmark.ayahNumber}</span>
                     </p>
                 </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                {juzList.map((juz) => (
                    <button
                        ...
                        onClick={() => alert('ميزة التصفح بالأجزاء قادمة قريباً')} // Placeholder logic
                    >
