                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-emerald-100 text-sm">
                            {lastRead.pageNumber ? (
                                <span>صفحة <span className="font-mono font-bold">{lastRead.pageNumber}</span></span>
                            ) : (
                                <span>الآية <span className="font-mono font-bold">{lastRead.ayahNumber}</span></span>
                            )}
                        </p>
                    </div>
            ...
            <div className="space-y-2">
                ...
                <div className="grid gap-2">
                    {bookmarks.map((bm, idx) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-amber-50 dark:bg-amber-900/20 rounded-lg flex items-center justify-center text-amber-600 dark:text-amber-400">
